  ...
  private int stateGoodness(GameState gState) {
    ...
    for(int l = 0; l < gState.BOARD_SIZE; l++) {
      ...
      for(int i = 0; i < gState.BOARD_SIZE; i++) {
        ...
        // diagonal 2
        if(gState.at(i, gState.BOARD_SIZE-1-i, l) == opMarks && diag2) {
          if(diag2pts < 0) {
            diag2pts = 0;
            diag2 = false;
          } else {
    ...
    for(int r = 0; r < gState.BOARD_SIZE; r++) {
      ...
      for(int i = 0; i < gState.BOARD_SIZE; i++) {
        ...
        // diagonal 2
        if(gState.at(r, i, gState.BOARD_SIZE-1-i) == opMarks && diag2) {
          if(diag2pts < 0) {
            diag2pts = 0;
            diag2 = false;
          } else {
      ...
      for(int i = 0; i < gState.BOARD_SIZE; i++) {
        ...
        // diagonal 2
        if(gState.at(i, r, gState.BOARD_SIZE-1-i) == opMarks && diag2) {
          if(diag2pts < 0) {
            diag2pts = 0;
            diag2 = false;
          } else {
    ...
    for(int i = 0; i < gState.BOARD_SIZE; i++) {
      ...
      // diagonal 2
      if(gState.at(gState.BOARD_SIZE-1-i, i, i) == opMarks && diag2) {
        if(diag2pts < 0) {
          diag2pts = 0;
          diag2 = false;
        } else {
      ...
      // diagonal 4
      if(gState.at(gState.BOARD_SIZE-1-i, gState.BOARD_SIZE-1-i, i) == opMarks && diag4) {
        if(diag4pts < 0) {
          diag4pts = 0;
          diag4 = false;
        } else {
